...
#ifndef SIMPLEBMP280Wire_H
#define SIMPLEBMP280Wire_H

#include "Arduino.h"
#include "Wire.h"

class SimpleBMP280Wire {
public:
	SimpleBMP280Wire(int8_t = 0x76);
	boolean begin();
...
private:
	...
	void writeCmd(BMP280registers, uint8_t);
	uint8_t retrieveData(BMP280registers, int8_t);

};

#endif //  SIMPLEBMP280Wire_H
